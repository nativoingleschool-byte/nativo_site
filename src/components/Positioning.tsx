    ...
    <section className="py-[160px] px-6 bg-white">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-24 items-center">
        <div className="space-y-8">
          <h2 className="text-5xl font-extrabold text-primary leading-tight">Explore o mundo sem fronteiras linguísticas</h2>
          <p className="text-xl text-on-surface-variant leading-relaxed font-light">
            A Nativo é uma escola de inglês online focada em fluência real. Aulas dinâmicas, abordagem comunicativa e ensino adaptado ao seu ritmo de vida.
          </p>
          <div className="flex gap-4 items-center">
            <div className="h-[2px] w-16 bg-secondary"></div>
            <span className="font-semibold text-secondary tracking-widest text-sm uppercase">Excelência Acadêmica</span>
          </div>
        </div>
        <div className="relative">
          ...
          <div className="absolute -bottom-10 -left-10 bg-primary p-12 rounded-2xl text-white shadow-2xl hidden lg:block max-w-xs">
            <p className="text-2xl font-medium italic leading-snug">"Aulas adaptadas aos seus objetivos reais."</p>
          </div>
        </div>
      </div>
    </section>
