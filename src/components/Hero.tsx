    ...
    <section className="relative min-h-[90vh] flex items-center pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden bg-background">
      ...
      <div className="relative z-20 px-6 md:px-16 max-w-7xl mx-auto w-full">
        <div className="max-w-2xl">
          <span className="text-secondary font-bold tracking-[0.2em] mb-6 block uppercase text-xs">O futuro da sua comunicação</span>
          <h1 className="hero-title text-primary mb-8 text-5xl sm:text-6xl md:text-8xl">Fale inglês com confiança.</h1>
          <p className="text-lg text-on-surface-variant mb-12 max-w-xl leading-relaxed font-light">
            Esqueça métodos engessados. Na Nativo, guiamos você até a fluência com uma abordagem prática, direta e adaptada aos seus objetivos reais.
          </p>
